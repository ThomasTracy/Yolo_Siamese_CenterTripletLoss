...
restore_path = './checkpoint/model-epoch_490_step_66284_loss_0.3861_lr_1e-05'  # The path of the weights to restore.
...
class_name_path = './data/my_data/traffic_sign.names'  # The path of the class names.
